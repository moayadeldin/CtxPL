...
parser = argparse.ArgumentParser(description='CTXPL')
...
parser.add_argument('--use_model', type=str, default='CTXPL', help='model used to train the network')
...
parser.add_argument("--activate_HNCPs", action='store_true')

# adding arg for temperature
# parser.add_argument('--temperature', type=float, default=0.35, help='Temperature for contrastive loss')